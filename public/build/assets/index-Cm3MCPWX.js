import{s as d}from"./index-CGgUQo_s.js";import{s as m}from"./index-C29WRRSE.js";import{bZ as u,aE as i,u as r,aQ as s,am as c,s as p,aT as l,t,b3 as g}from"./app-DmW52sVY.js";var v=function(o){var e=o.dt;return`
.p-chip {
    display: inline-flex;
    align-items: center;
...
`)},f={root:"p-chip p-component",image:"p-chip-image",icon:"p-chip-icon",label:"p-chip-label",removeIcon:"p-chip-remove-icon"},y=u.extend({name:"chip",theme:v,classes:f}),b={name:"BaseChip",extends:m,props:{label:{type:String,default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:y,provide:function(){return{$pcChip:this,$parentInstance:this}}},k={name:"Chip",extends:b,inheritAttrs:!1,emits:["remove"],data:function(){return{visible:!0}},methods:{onKeydown:function(o){(o.key==="Enter"||o.key==="Backspace")&&this.close(o)},close:function(o){this.visible=!1,this.$emit("remove",o)}},components:{TimesCircleIcon:d}},w=["aria-label"],C=["src"];function I(n,o,e,$,h,a){return h.visible?(i(),r("div",c({key:0,class:n.cx("root"),"aria-label":n.label},n.ptmi("root")),[s(n.$slots,"default",{},function(){return[n.image?(i(),r("img",c({key:0,src:n.image},n.ptm("image"),{class:n.cx("image")}),null,16,C)):n.$slots.icon?(i(),p(l(n.$slots.icon),c({key:1,class:n.cx("icon")},n.ptm("icon")),null,16,["class"])):n.icon?(i(),r("span",c({key:2,class:[n.cx("icon"),n.icon]},n.ptm("icon")),null,16)):t("",!0),n.label?(i(),r("div",c({key:3,class:n.cx("label")},n.ptm("label")),g(n.label),17)):t("",!0)]}),n.removable?s(n.$slots,"removeicon",{key:0,removeCallback:a.close,keydownCallback:a.onKeydown},function(){return[(i(),p(l(n.removeIcon?"span":"TimesCircleIcon"),c({tabindex:"0",class:[n.cx("removeIcon"),n.removeIcon],onClick:a.close,onKeydown:a.onKeydown},n.ptm("removeIcon")),null,16,["class","onClick","onKeydown"]))]}):t("",!0)],16,w)):t("",!0)}k.render=I;export{k as s};
