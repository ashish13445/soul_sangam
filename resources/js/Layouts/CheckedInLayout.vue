            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('eventDashboard')">
                                    <ApplicationLogo
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('eventDashboard')" :active="route().current('dashboard')">
                            Event Dashboard
                        </ResponsiveNavLink>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <ResponsiveNavLink :href="route('checkout')" method="post" as="button">
                                Check Out
                            </ResponsiveNavLink>
                        </div>
                    </div>
