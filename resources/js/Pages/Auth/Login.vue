    ...
    <div class="card flex justify-center">
        ...
        <Dialog v-model:visible="visible" pt:root:class="!border-0" pt:mask:class="backdrop-blur-sm">
            <template #container="{ closeCallback }">
                <div class="flex flex-col pt-8 gap-6" style="border-radius: 12px; background-image: radial-gradient(circle at left top, var(--p-primary-400), var(--p-primary-700))">
        ...
        <form @submit.prevent="submit" class="md:w-1/2 p-10 bg-white rounded mt-6 w-content">
            <div>
                <InputLabel for="email" value="Email" />
